package mx.com.cinepolis.digital.booking.service.distributor;
...
/**
 * Interface qie define los metodos asociados ala administracion de distribuidores
 * 
 * @author rgarcia
 */
@Local
public interface ServiceAdminDistributorEJB
{
  /**
