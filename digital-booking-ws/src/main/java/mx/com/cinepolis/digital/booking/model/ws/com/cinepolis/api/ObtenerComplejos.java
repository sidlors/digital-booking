 ...
 *       &lt;sequence>
 *         &lt;element name="idsCiudades" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
...
@XmlRootElement(name = "ObtenerComplejos")
public class ObtenerComplejos {

    @XmlElementRef(name = "idsCiudades", namespace = "http://api.cinepolis.com", type = JAXBElement.class)
    protected JAXBElement<String> idsCiudades;
    ...
    /**
     * Gets the value of the idsCiudades property.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public JAXBElement<String> getIdsCiudades() {
        return idsCiudades;
    }

    /**
     * Sets the value of the idsCiudades property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public void setIdsCiudades(JAXBElement<String> value) {
        this.idsCiudades = ((JAXBElement<String> ) value);
    }
