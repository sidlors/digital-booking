package mx.com.cinepolis.digital.booking.integration.region;
...
/**
 * Interface que define los servicios de integracion para las regiones
 * 
 * @author rgarcia
 */
public interface ServiceAdminRegionIntegratorEJB
{
